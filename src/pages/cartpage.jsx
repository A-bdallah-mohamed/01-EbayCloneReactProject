...
<Link to={`/pages/Productpage/${product.id}`}>
  <img src={product.thumbnail} className='w-auto max-h-[180px]'></img></Link>
</div>
<div className='justify-between flex w-full'>
<Link to={`/pages/Productpage/${product.id}`}>
  <div className='font-semibold underline hover:text-gray-500 cursor-pointer'>{product.title}</div></Link>
